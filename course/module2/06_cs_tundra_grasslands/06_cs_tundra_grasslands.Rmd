...
This exercise we'll be conducted with R and RStudio. If you haven't already done this, refer to this tutorial regarding the environment setup:
[R environment setup tutorial](../../software/software_r_language.md).
...
Serrano, A. J., Soria, E., Martin, J. D., Magdalena, R., & Gomez, J. (2010, July). *Feature selection using roc curves on classification problems*. In The 2010 International Joint Conference on Neural Networks (IJCNN) (pp. 1-6). IEEE. [https://doi.org/10.1109/ijcnn.2010.5596692](https://doi.org/10.1109/ijcnn.2010.5596692)
...
* Karatzoglou A, Smola A, Hornik K (2023). *kernlab: Kernel-Based Machine Learning Lab*. R package version 0.9-32, [https://CRAN.R-project.org/package=kernlab](https://CRAN.R-project.org/package=kernlab).
...
* Kuhn, M. (2008). *Building Predictive Models in R Using the caret Package*. Journal of Statistical Software, 28(5), 1–26. [https://doi.org/10.18637/jss.v028.i05](https://doi.org/10.18637/jss.v028.i05)
...
*  Xiao N (2023). _ggsci: Scientific Journal and Sci-Fi Themed Color Palettes for 'ggplot2'_. R package version 3.0.0, [https://CRAN.R-project.org/package=ggsci](https://CRAN.R-project.org/package=ggsci).
