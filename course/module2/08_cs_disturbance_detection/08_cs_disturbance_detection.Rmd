...
Firstly, load required libraries into the environment: `terra`, `sf`, `dplyr`, `readxl`, `writexl` and `tools`. Functions included in these packages will be used further in this case study.
